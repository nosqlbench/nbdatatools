...
/// A reader for uniform mvec files (minivec, f16 half-precision float vectors).
///
...
public class UniformMvecStreamer implements BoundedVectorFileStream<float[]> {
  ...
  /// Creates a new UniformMvecStreamer.
  public UniformMvecStreamer() {
  }

  /// Opens the mvec file at the given path for streaming.
  /// @param filePath
  ///     The path to the mvec file

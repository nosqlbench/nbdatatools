...
@DataType(int[].class)
@Encoding(Encoding.Type.ivec)
public class UniformIvecStreamer implements SizedStreamer<int[]>, AutoCloseable {
    ...
    public UniformIvecStreamer(Path filePath) throws IOException {

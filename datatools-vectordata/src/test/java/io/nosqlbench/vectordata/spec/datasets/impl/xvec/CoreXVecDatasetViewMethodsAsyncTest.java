...
public class CoreXVecDatasetViewMethodsAsyncTest {
    ...
    public void testAsyncMethodsExist() throws NoSuchMethodException {
        ...
        var getRangeAsync = clazz.getDeclaredMethod("getRangeAsync", long.class, long.class);
        ...
        var getIndexedAsync = clazz.getDeclaredMethod("getIndexedAsync", long.class);
        ...
        var getIndexedRangeAsync = clazz.getDeclaredMethod("getIndexedRangeAsync", long.class, long.class);

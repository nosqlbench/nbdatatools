...
public class NeighborIndicesXvecImpl extends IntVectorsXvecImpl implements NeighborIndices {
  ...
  /// Create a new NeighborIndices view for xvec data via channel.
  ...
  /// Create a new NeighborIndices view backed by a memory-mapped file.
  /// @param filePath The path to the xvec file
  /// @param window The configured window describing the slice of data to expose
  /// @param extension The file extension (used to derive the vector format)
  public NeighborIndicesXvecImpl(Path filePath, DSWindow window, String extension) {

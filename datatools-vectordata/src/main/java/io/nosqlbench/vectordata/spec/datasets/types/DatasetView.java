...
public interface DatasetView<T> extends Iterable<T> {
    ...
    /// @return the vectors
    T[] getRange(long startInclusive, long endExclusive);
    ...
    Future<T[]> getRangeAsync(long startInclusive, long endExclusive);

    /// get a vector by its ordinal
    ///
    /// @param index the ordinal of the vector to get
    /// @return the vector
    Indexed<T> getIndexed(long index);

    /// get an indexed vector asynchronously
    ///
    /// @param index the ordinal of the vector to get
    /// @return a future for the vector
    Future<Indexed<T>> getIndexedAsync(long index);
    ...
    /// @param endExclusive   the last ordinal to get
    /// @return a future for the vectors
    Future<Indexed<T>[]> getIndexedRangeAsync(long startInclusive, long endExclusive);

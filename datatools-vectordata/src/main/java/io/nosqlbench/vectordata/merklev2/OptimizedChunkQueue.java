...
public class OptimizedChunkQueue implements SchedulingTarget {
    ...
    public boolean equals(Object o) {
        if (this == o) return true;
        if (o == null || getClass() != o.getClass()) return false;
        OptimizedChunkQueue that = (OptimizedChunkQueue) o;
        return maxHistorySize == that.maxHistorySize &&
               ...
               Objects.equals(schedulingLock, that.schedulingLock) &&
               Objects.equals(meterRegistry, that.meterRegistry);
    }

    @Override
    public int hashCode() {
        return Objects.hash(taskQueue, inFlightFutures, completedTasksHistory, maxHistorySize, schedulingLock, meterRegistry);
    }

    @Override
    public String toString() {
        return "OptimizedChunkQueue{" +
               "taskQueue=" + taskQueue +

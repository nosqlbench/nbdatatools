...
class VectorGenerateTest {
    ...
    void testGenerateFloatVectors() throws Exception {
        ...
        VectorFileArray<float[]> vectors = VectorFileIO.vectorFileArray(FileType.xvec, float[].class, outputPath);
    ...
    void testGenerateIntVectors() throws Exception {
        ...
        // Verify the generated vectors
        VectorFileArray<int[]> vectors = VectorFileIO.vectorFileArray(FileType.xvec, int[].class, outputPath);
    ...
    void testGenerateDoubleVectorsWithCustomRange() throws Exception {
        ...
        // Verify the generated vectors
        VectorFileArray<double[]> vectors = VectorFileIO.vectorFileArray(FileType.xvec, double[].class, outputPath);

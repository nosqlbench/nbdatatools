...
import io.nosqlbench.command.json.subcommands.jjq.bulkio.LineChunker;
...
public class LineChunkerTest {
  ...
  public void testBasicChunking() {
    ...
    assertThat(lineChunker.next().toString()).isEqualTo("one two three four five\n" +
        "six seven eight nine ten\n" +
        "eleven twelve thirteen fourteen fifteen");
    assertTrue(lineChunker.hasNext());
    assertThat(lineChunker.next().toString()).isEqualTo("sixteen seventeen eighteen nineteen twenty\n" +

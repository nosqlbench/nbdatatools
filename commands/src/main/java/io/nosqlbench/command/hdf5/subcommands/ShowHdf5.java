...
public class ShowHdf5 implements Callable<Integer> {

  private static final Logger logger = LogManager.getLogger(ShowHdf5.class);
  ...
  /// Create a new ShowHdf5 command
  /// 
  /// Default constructor that initializes a new show subcommand instance.
  public ShowHdf5() {
  }

  @Override
  public Integer call() {
    logger.info("Executing show command on file: {}", file);

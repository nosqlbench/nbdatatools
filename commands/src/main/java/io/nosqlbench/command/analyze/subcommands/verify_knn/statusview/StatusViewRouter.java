...
/// A router implementation of StatusView that aggregates multiple status views.
/// This allows sending status updates to multiple destinations simultaneously.
/// Each method call is forwarded to all registered status views.
public class StatusViewRouter implements StatusView {
  private final List<StatusView> statusViewList = new ArrayList<>();

  /// Default constructor for StatusViewRouter
  public StatusViewRouter() {
  }

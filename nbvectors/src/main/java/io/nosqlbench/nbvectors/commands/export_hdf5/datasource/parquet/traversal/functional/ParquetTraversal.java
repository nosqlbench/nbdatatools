...
import io.nosqlbench.nbvectors.commands.export_hdf5.datasource.parquet.layout.PageSupplier;
...
public class ParquetTraversal {
  ...
  private static final Logger logger = LoggerFactory.getLogger(ParquetTraversal.class);

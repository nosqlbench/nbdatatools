...
- `--preferred-page-size <bytes>` — flush threshold (default 65536)
...
| `preferred_page_size` | u32  | 65536    | Must be >= min_page_size and <= max_page_size   |
...
| IoError               | underlying error                 | An I/O error from the file system                              |

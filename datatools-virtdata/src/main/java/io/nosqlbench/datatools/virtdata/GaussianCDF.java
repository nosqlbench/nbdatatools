 ...
 * <h2>Purpose</h2>
 *
 * <p>This class provides the forward CDF Φ(x) = P(X ≤ x) for the standard normal
 * distribution. It is used in conjunction with {@link InverseGaussianCDF} to
 ...
 * }</pre>
 *
 * <h2>Role in Truncated Normal Sampling</h2>
 *
 * <pre>{@code
...
public final class GaussianCDF {
     ...
     *
     * <p>Uses the relationship Φ(x) = ½[1 + erf(x/√2)] where erf is the
     ...
     *
     * <p>Uses the Abramowitz and Stegun approximation (7.1.26) which provides

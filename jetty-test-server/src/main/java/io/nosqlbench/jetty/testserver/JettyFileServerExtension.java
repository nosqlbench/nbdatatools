...
public class JettyFileServerExtension implements BeforeAllCallback, AfterAllCallback {
  ...
  /// Where static test resources live. The server will throw an error if tests modify contents
  /// here.
  public static final Path DEFAULT_RESOURCES_ROOT;
  /// Where dynamic resources live. Tests are free to modify contents here.

...
/// Forward Normal CDF (cumulative distribution function) using error function.
///
/// # Purpose
///
/// This class provides the forward CDF Φ(x) = P(X ≤ x) for the standard normal
/// distribution. It is used in conjunction with inverse CDF functions
...
public final class NormalCDF {
    ...
    /// Computes the CDF for a normal distribution with specified mean and stdDev.
    ///
    /// @param x the value at which to evaluate the CDF

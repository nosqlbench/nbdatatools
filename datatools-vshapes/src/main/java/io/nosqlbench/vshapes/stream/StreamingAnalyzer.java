 ...
 * <h2>Purpose</h2>
 *
 * <p>Implementations of this interface analyze vector data streamed in chunks,
 * accumulating state across chunks, and finally producing a model of type {@code M}.
 ...
 * <h2>Thread Safety</h2>
 *
 * <p>Implementations <b>must be thread-safe</b>. The {@code accept()} method may be
 ...
 *
 * <h2>Usage with AnalyzerHarness</h2>
 *
 * <pre>{@code
...
public interface StreamingAnalyzer<M> {
     ...
     * <ul>
     *   <li>Retrieve results from {@link AnalysisResults}</li>
     *   <li>Report errors for specific analyzers</li>
     *   <li>Log and monitor analyzer execution</li>
     * </ul>
     *
     ...
     *
     * <p>Called exactly once before any chunks are delivered. Use this to:
     * <ul>
     *   <li>Allocate per-dimension data structures</li>
     *   <li>Read configuration from parameters</li>
     *   <li>Initialize accumulators</li>
     * </ul>
     *
     ...
     *
     * <p>Called multiple times with successive chunks of the dataset.
     * Each chunk is a 2D array where:
     * <ul>
     *   <li>{@code chunk[i]} is the i-th vector in this chunk</li>
     *   <li>{@code chunk[i][d]} is dimension d of vector i</li>
     *   <li>{@code chunk.length} may vary between calls (last chunk may be smaller)</li>
     * </ul>
     *
     * <p><b>Thread Safety:</b> This method may be called concurrently from multiple
     ...
     *
     * <p>Called exactly once after all chunks have been processed. Use this to:
     * <ul>
     *   <li>Compute final statistics from accumulated data</li>
     *   <li>Fit models to collected samples</li>
     *   <li>Build and return the final result</li>
     * </ul>
     *
     ...
     *
     * <p>This is a hint for the harness to schedule analyzers efficiently.
     * Return 0 if unknown.
     *
     ...
     *
     * <p>Used for logging and reporting.
     *

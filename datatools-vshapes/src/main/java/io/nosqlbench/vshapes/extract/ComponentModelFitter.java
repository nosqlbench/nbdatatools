 ...
 *
 * <p>Each fitter computes a goodness-of-fit score that can be used to compare
 * how well different distribution types match the data. Lower scores indicate
 * better fit. The {@link BestFitSelector} uses these scores to choose the
...
public interface ComponentModelFitter {
     ...
     *
     * <p>This method is more efficient when statistics have already been

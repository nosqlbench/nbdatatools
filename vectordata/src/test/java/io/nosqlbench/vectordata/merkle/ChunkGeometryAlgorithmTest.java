...
/**
 * Tests the ChunkGeometryDescriptor chunk size calculation algorithm.
 */
public class ChunkGeometryAlgorithmTest {

    @Test
    public void testChunkSizeCalculationAlgorithm() {
        // Test minimum chunk size (1MB) for small files
        ChunkGeometryDescriptor small = new ChunkGeometryDescriptor(1024 * 1024); // 1MB file
        ...
        ChunkGeometryDescriptor medium = new ChunkGeometryDescriptor(fourGB);
        ...
        ChunkGeometryDescriptor large = new ChunkGeometryDescriptor(fiveGB);
        ...
        ChunkGeometryDescriptor veryLarge = new ChunkGeometryDescriptor(very_large);
        ...
        // Test powers of 2
        ChunkGeometryDescriptor test1 = new ChunkGeometryDescriptor(32L * 1024L * 1024L * 1024L); // 32GB
        assertTrue(Long.bitCount(test1.getChunkSize()) == 1, "Chunk size should be power of 2");

        // Test zero content size
        ChunkGeometryDescriptor empty = new ChunkGeometryDescriptor(0);
    ...
    public void testChunkSizeScaling() {
        ...
        ChunkGeometryDescriptor at4GB = new ChunkGeometryDescriptor(4L * 1024L * 1024L * 1024L);
        assertEquals(1024 * 1024L, at4GB.getChunkSize());
        assertEquals(4096, at4GB.getTotalChunks());

        // Just over 4GB: should scale to 2MB chunks
        ChunkGeometryDescriptor over4GB = new ChunkGeometryDescriptor(4L * 1024L * 1024L * 1024L + 1);
        assertEquals(2 * 1024 * 1024L, over4GB.getChunkSize());
        assertTrue(over4GB.getTotalChunks() <= 4096);

        // At 8GB: 2MB chunks, 4096 chunks
        ChunkGeometryDescriptor at8GB = new ChunkGeometryDescriptor(8L * 1024L * 1024L * 1024L);
        ...
        ChunkGeometryDescriptor at256GB = new ChunkGeometryDescriptor(256L * 1024L * 1024L * 1024L);
        ...
        ChunkGeometryDescriptor at1TB = new ChunkGeometryDescriptor(1024L * 1024L * 1024L * 1024L);
    ...
    public void testCohereScenario() {
        ...
        ChunkGeometryDescriptor cohere = new ChunkGeometryDescriptor(cohereSize);

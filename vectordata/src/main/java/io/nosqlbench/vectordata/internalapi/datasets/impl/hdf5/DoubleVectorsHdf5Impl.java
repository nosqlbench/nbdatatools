...
import io.nosqlbench.vectordata.internalapi.datasets.api.DoubleVectors;
import io.nosqlbench.vectordata.layout.FWindow;

/// a view of double vectors data
public class DoubleVectorsHdf5Impl extends CoreHdf5DatasetViewMethods<double[]> implements
                                                                                DoubleVectors
{

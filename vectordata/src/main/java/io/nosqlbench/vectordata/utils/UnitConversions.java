...
public class UnitConversions {
  ...
  /// @param spec The duration string to convert
  /// @return An Optional containing the duration in the specified unit, or empty if the string couldn't be parsed
  ...
  ///
  /// @param spec The count string to convert
  ...
  /// @param resultUnit The unit to convert to
  /// @param spec The count string to convert
  /// @return An Optional containing the count as a double in the specified unit, or empty if the string couldn't be parsed
  ...
  /// @param resultUnit The unit to convert to
  /// @param spec The count string to convert
  /// @return An Optional containing the count as a long in the specified unit, or empty if the string couldn't be parsed
  ...
  ///
  /// @param spec The bytes string to convert
  ...
  /// @param resultUnit The unit to convert to
  /// @param spec The bytes string to convert
  /// @return An Optional containing the bytes as a double in the specified unit, or empty if the string couldn't be parsed
  ...
  ///
  /// This enum defines the possible units for duration values, such as nanoseconds, microseconds, milliseconds, etc.

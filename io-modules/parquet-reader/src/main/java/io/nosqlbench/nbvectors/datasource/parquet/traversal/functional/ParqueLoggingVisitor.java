...
//    System.out.println("after input file " + inputFile);
  ...
  /// {@inheritDoc}
  @Override
  public void afterPage(io.nosqlbench.nbvectors.commands.export_hdf5.datasource.parquet.traversal.functional.BoundedPageStore pageStore) {
...
//    System.out.println("before input file " + inputFile);
  ...
  /// {@inheritDoc}
  @Override
  public void beforePage(io.nosqlbench.nbvectors.commands.export_hdf5.datasource.parquet.traversal.functional.BoundedPageStore pageStore) {
